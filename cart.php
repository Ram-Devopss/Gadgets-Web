<?php
    ...
    $user_id=$_SESSION['id'];
    $user_products_query="select it.id,it.product,it.price from users_items ut inner join products it on it.id=ut.item_id where ut.user_id='$user_id'";
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                         ...
                         ?>
                        <tr>
                            <th><?php echo $counter ?></th><th><?php echo $row['product']?></th><th><?php echo $row['price']?></th>
